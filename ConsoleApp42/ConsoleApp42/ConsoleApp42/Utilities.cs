...
namespace ConsoleApp42
{
    ...
    {
        private static string directory = @"C:\Users\IshansiAgrawal\Downloads\code\ConsoleApp42\Assets\ConsoleApp42.Logic.dll";
        private static string fileName = "String Questions.txt";
